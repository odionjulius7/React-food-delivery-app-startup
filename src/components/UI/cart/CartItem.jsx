...
const CartItem = ({ item }) => {
  // the id is unique to each item and once you click it recognises that particular id
      ...
      <div className="cart__item-info d-flex gap-2">
        ...
        <div className="cart__product-info w-100 d-flex align-items-center gap-4 justify-content-between">
          <div>
            ...
            <div className=" d-flex align-items-center justify-content-between increasee__decrease-btn">
